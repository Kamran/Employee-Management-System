    ...
    <div class="row">
        <div class="col-md-11">
            <div class="panel panel-default">
                ...
                <h3 class="box-title" style="font-weight:bolder; text-transform:uppercase; font-family: 'Times New Roman', Times, serif; color:red"> Update Designation</h3>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-refresh"></i>  Update Designation
                                </button>
                            </div>
                        </div>
                    </form>
