 ...
 <section class="content">
    ...
    <div class="row">
      <div class="col-md-7  pull-left">
        <button type="button" class="btn btn-info pull-right " style="margin-top:40px;"> <a href="{{ url('employee-management') }}" class="text-black"><i class="fa fa-plus color-white"></i> <b>Add New Employee</b> </a></button>
        {{-- <button class="btn btn-primary text-red"><a href="{{ url('employee-management') }}"><i class="fa fa-user fa-lg"></i>  Add Employees </a></button>  --}}
      </div>
    </div>
    {{-- <div class="row">
      <!-- /.col -->
